package net.greeta.stock.dataaccess.outbox.restaurantapproval.repository;

import net.greeta.stock.dataaccess.outbox.restaurantapproval.entity.ApprovalOutboxEntity;
