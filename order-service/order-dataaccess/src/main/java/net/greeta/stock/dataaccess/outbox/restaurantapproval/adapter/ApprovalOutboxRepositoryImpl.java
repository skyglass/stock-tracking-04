package net.greeta.stock.dataaccess.outbox.restaurantapproval.adapter;

import net.greeta.stock.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import net.greeta.stock.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import net.greeta.stock.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
